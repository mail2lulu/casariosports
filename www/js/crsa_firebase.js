...
window.crsapp = window.crsapp || {};

/**
 * Handles all Firebase interactions.
 */
crsapp.Firebase = class {
    /**
     ...
     */
    getPosts() {
        return this._getPaginatedFeed('/posts/', crsapp.Firebase.POSTS_PAGE_SIZE);
    }
    ...
    getHomeFeedPosts() {
        return this._getPaginatedFeed(`/feed/${this.auth.currentUser.uid}`,
            crsapp.Firebase.POSTS_PAGE_SIZE, null, true);
    }
    ...
    getUserFeedPosts(uid) {
        return this._getPaginatedFeed(`/people/${uid}/posts`,
            crsapp.Firebase.USER_PAGE_POSTS_PAGE_SIZE, null, true);
    }
     ...
     */
    uploadSimplePic(pic, fileName, text) {
...
crsapp.firebase = new crsapp.Firebase();
